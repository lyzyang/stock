...
STOP_LOSS_PCT = 0.01         # 止损比例 2%
TAKE_PROFIT_PCT = 0.012       # 止盈比例 2%

# 出场阶段动态建议参数
EXIT_TRIGGER_RSI = 52        # 出场动态建议 RSI 阈值
EXIT_TRIGGER_BOLLINGER_PCT = 0.003  # 出场动态建议布林带偏离比例

# 反T上涨保护参数
NEGATIVE_T_BOLLINGER_STOP_PCT = 0.004  # 反T卖出后，突破布林上轨一定比例即止损接回
...
# ========== 运行配置 ==========
KLINE_PERIOD = "5min"        # 主分析周期: 1min, 5min, 15min, 30min, 60min
